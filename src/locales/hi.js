module.exports = {
  ...
  helpBody:
    ...
    '/withdrawals — पेंडिंग विथड्रॉ अनुरोध सूची (सिर्फ़ ओनर)\n' +
    '/approvewithdraw <id> — विथड्रॉ भेजा गया मार्क करें\n' +
    '/rejectwithdraw <id> — विथड्रॉ अस्वीकार करें और बैलेंस वापस करें\n\n' +
