module.exports = {
  ...
  ownerHelpBody: `/start — Khởi động bot và hiển thị lời chào\n/help — Danh sách lệnh này\n/announcement — Gửi tin nhắn văn bản đến tất cả người dùng\n/announcementimage — Gửi hình ảnh + văn bản đến tất cả người dùng\n/addadmin <telegram_id> — Thêm quản trị viên mới (chỉ chủ sở hữu)\n/removeadmin <telegram_id> — Xóa quản trị viên (chỉ chủ sở hữu)\n/stats — Thống kê người dùng/quản trị viên của bot\n/totalusers — Tổng số người dùng đã khởi động bot\n/withdrawals — Danh sách yêu cầu rút tiền đang chờ\n/approvewithdraw <id> — Đánh dấu rút tiền là đã gửi\n/rejectwithdraw <id> — Từ chối rút tiền và hoàn lại số dư\n\nℹ️ Nhiệm vụ được thêm/chỉnh sửa từ phần *Earn* trong Mini App.`,
  adminHelpTitle: `🛠 *Danh sách lệnh của Quản trị viên — ZORY X BOT*`,
  adminHelpBody: `/announcement — Gửi tin nhắn văn bản đến tất cả người dùng\n/announcementimage — Gửi hình ảnh + văn bản đến tất cả người dùng\n/totalusers — Tổng số người dùng đã khởi động bot\n/withdrawals — Danh sách yêu cầu rút tiền đang chờ\n/approvewithdraw <id> — Đánh dấu rút tiền là đã gửi\n/rejectwithdraw <id> — Từ chối rút tiền và hoàn lại số dư`,
  announcementAsk: `📢 Bây giờ hãy gửi nội dung thông báo của bạn. Nó sẽ được gửi đến tất cả người dùng.`,
  announcementImageAsk: `🖼️ Bây giờ hãy gửi hình ảnh cho thông báo của bạn.`,
  announcementCaptionAsk: `📝 Đã nhận hình ảnh! Bây giờ hãy gửi nội dung văn bản đi kèm.`,
  announcementButtonAsk: `🔗 Bạn có muốn thêm nút vào tin nhắn này không? Gửi liên kết (bắt đầu bằng http:// hoặc https://), hoặc gửi /nobutton để gửi không có nút.`,
  announcementInvalidUrl: `⚠️ Đây có vẻ không phải là liên kết hợp lệ. Vui lòng gửi liên kết bắt đầu bằng http:// hoặc https://, hoặc gửi /nobutton để bỏ qua.`,
  announcementButtonLabel: `🔗 Mở liên kết`,
