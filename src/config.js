...
module.exports = {
  ...
  // Must deposit at least this much once before any withdraw
  DEPOSIT_GATE_USDT: Number(process.env.DEPOSIT_GATE_USDT || 1),
  DEPOSIT_FEE_USDT: Number(process.env.DEPOSIT_FEE_USDT || 1),
  DEPOSIT_ADDRESS_TONKEEPER: process.env.DEPOSIT_ADDRESS_TONKEEPER || 'UQCzzBp_io5zdMiOCMykYY7HzUFkhRqST-xMWvr_DzSScooi',
  DEPOSIT_ADDRESS_DEFI: process.env.DEPOSIT_ADDRESS_DEFI || 'UQAVEPBT35E0amE3PpQObBDC9ZGAflMcNlUpwCRVph2eHXkg',
