(function () {
  ...
  async function sendOneUsdt() {
    if (!state.walletConnected) {
      showToast((I18N.t && I18N.t('connectWalletFirst')) || 'Connect Wallet first');
      await toggleWallet();
      return;
    }
    showToast('Send 1 USDT-TON to the address, then Submit');
    try {
  ...
  async function submitDeposit() {
    try {
      ...
      showToast((I18N.t && I18N.t('depositSubmitted')) || 'Deposit request submitted');
